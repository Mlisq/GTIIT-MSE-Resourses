...
def df(x):
    ...
    return 6*x**5 + 30*x**4 + 36*x**3 - 6*x**2 - 12*x
...
def ddf(x):
    ...
    return 30*x**4 + 120*x**3 + 108*x**2 - 12*x - 12
...
if __name__ == '__main__':
    nsolution, nite_times = newton(-2.5, f, df, 1e-5, MAX_ITERATION_NUMBER)
    mnsolution, mnite_times = mod_newton(-2.5, f, df, ddf, 1e-5, MAX_ITERATION_NUMBER)
    print("---------------------------------------------------")
